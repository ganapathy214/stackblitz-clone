            ...
            <div style={{ margin: "0% 2% 0% 8%", }}>
                ...
                <Row align={"middle"} style={{ paddingBottom: 50 }}>
                    <Col md={10}>
                        ...
                        <div style={{ padding: "10px 10px 30px 10px" }}>
                            <Text style={{ fontSize: 18, padding: "0 10px" }}>Speed up your entire development process with<strong>real time hot-reloading in the</strong> for your users to reliably submit</Text>
                            <Text style={{ fontSize: 18, padding: "0 10px" }}>
